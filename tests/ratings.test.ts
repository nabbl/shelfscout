...
const profile: Profile = { version: 'test', evidence: [], unknown: [], settings: { preferences: [], disabled: [], includeReviews: false, rereads: false }, preferences: [{ id: 'memory', dimension: 'theme', value: 'memory', direction: 'prefer', origin: 'explicit', confidence: 'supported', support: ['owner'], counterexamples: [] }] };
