...
const profile: Profile = { version: 'test', evidence: [], unknown: [], settings: { maxBookAgeYears: null, preferences: [], disabled: [], includeReviews: false, rereads: false, allowSeries: true, hiddenMoods: [], languages: ['en'] }, preferences: [{ id: 'memory', dimension: 'theme', value: 'memory', direction: 'prefer', origin: 'explicit', confidence: 'supported', support: ['owner'], counterexamples: [] }] };
