...
const firstDoc = { key: '/works/OL1W', title: 'The Beginning', author_name: ['Test Author'], subject: ['friendship'], series_key: ['OL123L'], series_name: [series.name], series_position: ['1'] };
