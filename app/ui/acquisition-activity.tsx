...
type Item = { id: string; title: string; author: string; language: string; status: string; last_error?: string; upstream_book_id?: string; upstream_request_id?: string; workflow: string; releases: ReleaseChoice[]; events: { status: string; detail: string; created_at: string }[] };
