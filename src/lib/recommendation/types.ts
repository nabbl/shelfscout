...
export const settingsSchema = z.object({ preferences: z.array(preferenceSchema).max(60).default([]), disabled: z.array(z.string().max(100)).max(100).default([]), includeReviews: z.boolean().default(false), rereads: z.boolean().default(false) });
