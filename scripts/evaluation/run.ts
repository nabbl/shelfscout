...
const p: Profile = { version: 'synthetic-reader-v1', preferences: [pref('memory'), pref('war', 'avoid')], evidence: [], settings: { preferences: [], disabled: [], includeReviews: false, rereads: false, allowSeries: true, hiddenMoods: [], languages: ['en'] }, unknown: [] };
